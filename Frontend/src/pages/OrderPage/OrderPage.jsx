...
const OrderPage = () => {
    ...
    return (
        <div style={{height: '150vh', width: '100%'}}>
            ...
            <StickyComponent />
            <div style={{padding: '10px 330px', height: '80%', margin: '0 auto'}}>
                <h2>Giỏ hàng</h2>
                    ...
                    <WrapperLeft>
                        <WrapperStyleHeader>
                            ...
                            <div style={{flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
                                ...
                                <DeleteOutlined style={{cursor: 'pointer', fontSize: '16px'}} onClick={handleDeleteAllOrder} />
                            </div>
                        </WrapperStyleHeader>
                        <WrapperListOrder>
                            {order?.orderItems?.map((order) => {
                                return (
                                    <WrapperItemOrder>
                                        <div style={{width: '335px', display: 'flex', alignItems: 'center', gap: '4'}} >
                                            <Checkbox onChange={onChange} value={order?.product} checked={listChecked.includes(order?.product)} ></Checkbox>
                                            <img src={order?.image} alt='order-pic' style={{width: '77px', height: '79px', objectFit: 'cover', marginLeft: '15px'}} />
                                            <div style={{
                                                marginLeft: '15px',
                                                width: '260px',
                                                overflow: 'hidden',
                                        ...
                                        <div style={{flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'space-between'}} >
                                            <span>
                                                ...
                                                <WrapperPriceDiscount>
                                                    {convertPrice((order?.price + (order?.price * 0.05)) * order?.amount)}₫
                                                </WrapperPriceDiscount>
                                            </span>
                                            <WrapperCountOrder style={{marginLeft: '-30px'}} >
                    ...
                    <WrapperRight>
                        <div style={{width: '100%'}} >
                            <WrapperInfo>
                                ...
                                <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
                                    <span>Thuế</span>
                                    <span style={{color: '#000', fontSize: '14px', fontWeight: 'bold'}}>{convertPrice(Math.round((priceMemo) * 0.05))}₫</span>
                                </div>
                                <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
                                    <span>Giảm giá</span>
                                    <span style={{color: '#000', fontSize: '14px', fontWeight: 'bold'}}>5%</span>
                                </div>
                                <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
                            ...
                            <WrapperTotal>
                                ...
                                <span style={{display: 'flex', flexDirection: 'column'}}>
                                    <span style={{color: 'rgb(254, 56, 52)', fontSize: '24px', fontWeight: 'bold'}} >{convertPrice(priceMemo + deliveryPriceMemo + (Math.round((priceMemo) * 0.05)))} VND</span>
            ...
            <ModalComponent forceRender title="Cập nhật thông tin giao hàng" open={isOpenModalUpdateInfo} onCancel={handleCancelUpdate} onOk={handleUpdateInfoUser} style={{marginTop: '250px'}}>
                <Pending isPending={isPending}>
                    ...
                    >
                        ...
                        >
                        <InputComponent style={{border: '1px #ccc solid'}} value={stateUserDetails.city} onChange={handleOnChangeDetails} name="city" />
                        </Form.Item>
